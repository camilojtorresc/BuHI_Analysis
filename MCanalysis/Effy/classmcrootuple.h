...
// Tue Dec 22 19:33:36 2020 by ROOT version 6.16/01
// from TTree ntuple/Bc ntuple
// found on file: ../dataMC/Rootuple_Bu_JpsiK_2016HI-RecoGenbacht1.root
//////////////////////////////////////////////////////////

#ifndef classmcrootuple_h
#define classmcrootuple_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   classmcrootuple(TTree *tree=0);
   virtual ~classmcrootuple();
...
#ifdef classmcrootuple_cxx
classmcrootuple::classmcrootuple(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("../dataMC/Rootuple_Bu_JpsiK_2016HI-RecoGenbacht1.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("../dataMC/Rootuple_Bu_JpsiK_2016HI-RecoGenbacht1.root");
      }
      TDirectory * dir = (TDirectory*)f->Get("../dataMC/Rootuple_Bu_JpsiK_2016HI-RecoGenbacht1.root:/rootuple");
...
classmcrootuple::~classmcrootuple()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t classmcrootuple::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t classmcrootuple::LoadTree(Long64_t entry)
{
...
void classmcrootuple::Init(TTree *tree)
{
...
void classmcrootuple::Show(Long64_t entry)
{
...
Int_t classmcrootuple::Cut(Long64_t entry)
{
...
#endif // #ifdef classmcrootuple_cxx
