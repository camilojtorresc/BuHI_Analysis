...
void Make_Bujk_AODHI_MC2016(int vq)
{
  TChain * ch = new TChain("ntuple","");
  ch->Add("/cms/jhovanny/mytest/BuHI/MCanalysis/dataMC/Rootuple_Bu_JpsiK_2016HI-MCAOD_bacht2.root/rootuple/ntuple");
  
  TTree *tree = (TTree*)ch;
  classntupleMC t(tree);
  Long64_t nentries = t.fChain->GetEntries();
  cout<<" Entries : "<<nentries<<endl;
  cout<<" Reading data ..."<<nentries<<endl;

  //TString outfileName( "ROOTS_Bujk_2018_AOD_1_best1.root" );
  TString outfileName(Form("ROOTS_Bujk_AOD_HI2016_MC_best%1i.root",vq) );
  ...
  treeS->Branch("gen_b_p4", &gen_b_p4);
  treeS->Branch("gen_pion1_p4", &gen_pion1_p4);
  treeS->Branch("gen_jpsi_p4", &gen_jpsi_p4);
  treeS->Branch("gen_muon1_p4", &gen_muon1_p4);
  treeS->Branch("gen_muon2_p4", &gen_muon2_p4);
  ...
  for(Long64_t jentry=0; jentry<nentries;jentry++) 
      ...
      for(unsigned int i=0;i<t.B_J_mass->size();i++)
	{
	  ...
	  gen_b_p4=t.gen_bc_p4;
	  gen_pion1_p4=t.gen_pion3_p4;
	  gen_jpsi_p4=t.gen_jpsi_p4;
