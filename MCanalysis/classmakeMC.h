...
// Tue Dec 22 15:20:45 2020 by ROOT version 6.16/01
// from TTree treeS/signal
// found on file: ROOTS_Bujk_AOD_HI2016_MC_best1.root
//////////////////////////////////////////////////////////

#ifndef classmakeMC_h
#define classmakeMC_h
...
#ifdef classmakeMC_cxx
classmakeMC::classmakeMC(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("ROOTS_Bujk_AOD_HI2016_MC_best1.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("ROOTS_Bujk_AOD_HI2016_MC_best1.root");
      }
...
classmakeMC::~classmakeMC()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t classmakeMC::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t classmakeMC::LoadTree(Long64_t entry)
{
...
void classmakeMC::Init(TTree *tree)
{
...
void classmakeMC::Show(Long64_t entry)
{
...
Int_t classmakeMC::Cut(Long64_t entry)
{
