...
// Thu Nov 26 01:05:41 2020 by ROOT version 6.22/02
// from TTree ntuple/Bc ntuple
// found on file: Rootuple_Bu_JpsiK_2016HI-AOD_9.root
//////////////////////////////////////////////////////////

#ifndef classntuple_h
#define classntuple_h
...
#ifdef classntuple_cxx
classntuple::classntuple(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("Rootuple_Bu_JpsiK_2016HI-AOD_9.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("Rootuple_Bu_JpsiK_2016HI-AOD_9.root");
      }
      TDirectory * dir = (TDirectory*)f->Get("Rootuple_Bu_JpsiK_2016HI-AOD_9.root:/rootuple");
...
classntuple::~classntuple()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t classntuple::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t classntuple::LoadTree(Long64_t entry)
{
...
void classntuple::Init(TTree *tree)
{
...
void classntuple::Show(Long64_t entry)
{
...
Int_t classntuple::Cut(Long64_t entry)
{
